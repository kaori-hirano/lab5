...
set.seed(16)
dim(d)
mls_cv <- sample(727, (727*.7)) # creates cv set with 70 of data
mls_test <- sample(727, (727*.3)) # creates test set with other 30
```
...
```
The best l is .0453. The test set MSE is .4669.
...
```
The optimal l is .0120. The test set MSE is .4986. The approach with the lowest test MSE is XXXXX
